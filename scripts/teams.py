...
from cuwo.entity import FLAGS_1_HOSTILE, EntityData, APPEARANCE_BIT
...
class TeamConnection(ConnectionScript):
    ...
    def on_death(self):
        ...
        if not self.last_hit_by.team is None:
...
class Team(object):
    ...
    def promote_leader(self):
        if self.leader is None or not self.leader in self.members:
